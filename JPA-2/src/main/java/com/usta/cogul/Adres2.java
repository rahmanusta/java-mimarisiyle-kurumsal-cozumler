...
@Entity
@Table(name = "Adres2_Tablo") // ifadesi tablo adını biçimlendirir.
public class Adres2 implements Serializable {
    ...
    public Adres2(Long id, String sokak1, String sokak2, String sehir, String bolge, String postaKodu, String ulke) {
        this.id = id;
        this.sokak1 = sokak1;
        this.sokak2 = sokak2;
        this.sehir = sehir;
