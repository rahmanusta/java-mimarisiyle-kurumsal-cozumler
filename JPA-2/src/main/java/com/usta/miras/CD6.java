 ...
 */
@Entity
@Table(name="CD6_Tablo")
public class CD6 extends Urun6{
    ...
    public CD6(String produksiyon, Integer parcaSayisi, Float toplamSure, String tur, String urunAdi, Double fiyat, String aciklama) {
